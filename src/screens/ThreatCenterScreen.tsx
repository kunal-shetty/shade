  ...
  return (
    <SafeAreaView style={styles.safe} edges={['left', 'right']}>
      <ScrollView contentContainerStyle={styles.container}>
        <Text style={[typography.h1, { color: c.text }]}>Threat Center</Text>
        ...
        <Text style={[typography.h2, { color: c.text }]}>Score Breakdown</Text>
        <Card>
        ...
        <Text style={[typography.h2, { color: c.text }]}>Sensor Health</Text>
